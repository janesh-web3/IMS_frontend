            ...
            <div className="grid gap-3">
              ...
              <ul className="grid gap-3">
                ...
                <li className="flex items-center justify-between">
                  ...
                  <span>
                    {personalInfo.guardianName} ({personalInfo.guardianContact})
                  </span>
                </li>
                <li className="flex items-center justify-between">
                  <span className="text-muted-foreground">Local Guardian </span>
                  <span>
                  ...
                  <div key={bill._id}>
                    <li className="flex items-center justify-between">
                      <Badge variant="outline" className="mr-1 ">
                        ...
                        <span className="font-normal">&nbsp;{bill.billNo}</span>
                      </Badge>
                      <div>
                        <p>
                          <span className="text-muted-foreground">
                          ...
                          <span>
                            &nbsp;
                            {new Date(bill.dateSubmitted).toLocaleDateString()}
                          </span>
                        </p>
                        <p>
                          <span className="text-muted-foreground">Paid:</span>
