      ...
      <div className="flex-1 max-h-screen px-2 space-y-4 md:p-8">
        <div className="items-center justify-between">
          <Tabs defaultValue="dashboard">
            <TabsList className="rounded-[2px]">
              <TabsTrigger value="dashboard" className="rounded-[2px]">
                Dashboard
              </TabsTrigger>
              <TabsTrigger value="list" className="rounded-[2px]">
                Task
              </TabsTrigger>
            </TabsList>
            ...
            {/* Task */}
            <TabsContent value="list" className="justify-between">
              <Tabs defaultValue="overview" className="space-y-4">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div>
                    <PopupModal
                      ...
                      renderModal={(onClose) => <h1>Modal</h1>}
                    />
                  </div>
                </div>
